...
from src.llm.base import ChatChunk, Message
from src.llm.gemini import GeminiProvider


def build_provider() -> GeminiProvider:
    with patch("src.llm.gemini.genai.Client", return_value=object()):
...
def test_gemini_provider_retries_transient_failures() -> None:
    ...
    with patch("src.llm.gemini.asyncio.sleep", new=AsyncMock()) as sleep_mock:
