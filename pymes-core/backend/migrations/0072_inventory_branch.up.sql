...
FROM one_branch ob
WHERE sl.tenant_id = ob.tenant_id
...
CREATE INDEX IF NOT EXISTS idx_stock_movements_org_branch
    ON stock_movements(tenant_id, branch_id, created_at DESC);
