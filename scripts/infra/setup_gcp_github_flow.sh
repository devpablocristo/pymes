...
WIF_PROVIDER_CONDITION="${WIF_PROVIDER_CONDITION:-((assertion.repository=='devpablocristo/pymes' || assertion.repository=='devpablocristo/companion' || assertion.repository=='devpablocristo/nexus' || assertion.repository=='devpablocristo/axis') && assertion.ref=='refs/heads/develop') || (assertion.repository=='devpablocristo/pymes' && assertion.ref=='refs/heads/main') || (assertion.repository=='devpablocristo/pymes' && assertion.event_name=='pull_request' && assertion.base_ref=='main')}"
