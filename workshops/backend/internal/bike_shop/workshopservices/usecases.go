...
func (u *Usecases) Create(ctx context.Context, in domain.Service, actor string) (domain.Service, error) {
	...
	if u.audit != nil {
		u.audit.Log(ctx, out.OrgID.String(), actor, "bike_shop.workshop_service.created", "workshop_service", out.ID.String(), map[string]any{"code": out.Code})
	}
	return out, nil
}
...
func (u *Usecases) Update(ctx context.Context, orgID, id uuid.UUID, in UpdateInput, actor string) (domain.Service, error) {
	...
	if u.audit != nil {
		u.audit.Log(ctx, out.OrgID.String(), actor, "bike_shop.workshop_service.updated", "workshop_service", out.ID.String(), map[string]any{"code": out.Code})
	}
	return out, nil
}
