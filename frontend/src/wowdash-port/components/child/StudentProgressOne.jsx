                ...
                <div className="card-body">
                    <div className="d-flex align-items-center justify-content-between gap-3 mb-24">
                        <div className="d-flex align-items-center">
                            <img
                                src="/wowdash-assets/images/home-six/student-img1.png"
                                alt=""
                    ...
                    <div className="d-flex align-items-center justify-content-between gap-3 mb-24">
                        <div className="d-flex align-items-center">
                            <img
                                src="/wowdash-assets/images/home-six/student-img2.png"
                                alt=""
                                className="w-40-px h-40-px radius-8 flex-shrink-0 me-12 overflow-hidden"
                            />
                            <div className="flex-grow-1">
                    ...
                    <div className="d-flex align-items-center justify-content-between gap-3 mb-24">
                        <div className="d-flex align-items-center">
                            <img
                                src="/wowdash-assets/images/home-six/student-img3.png"
                                alt=""
                                className="w-40-px h-40-px radius-8 flex-shrink-0 me-12 overflow-hidden"
                            />
                            <div className="flex-grow-1">
                    ...
                    <div className="d-flex align-items-center justify-content-between gap-3 mb-24">
                        <div className="d-flex align-items-center">
                            <img
                                src="/wowdash-assets/images/home-six/student-img4.png"
                                alt=""
                                className="w-40-px h-40-px radius-8 flex-shrink-0 me-12 overflow-hidden"
                            />
                            <div className="flex-grow-1">
                    ...
                    <div className="d-flex align-items-center justify-content-between gap-3 mb-24">
                        <div className="d-flex align-items-center">
                            <img
                                src="/wowdash-assets/images/home-six/student-img5.png"
                                alt=""
                                className="w-40-px h-40-px radius-8 flex-shrink-0 me-12 overflow-hidden"
                            />
                            <div className="flex-grow-1">
                    ...
                    <div className="d-flex align-items-center justify-content-between gap-3 mb-0">
                        <div className="d-flex align-items-center">
                            <img
                                src="/wowdash-assets/images/home-six/student-img6.png"
                                alt=""
                                className="w-40-px h-40-px radius-8 flex-shrink-0 me-12 overflow-hidden"
                            />
                            <div className="flex-grow-1">
