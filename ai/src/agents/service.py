...
from src.agents.service_support import (
    ...
    _persist_dossier_if_changed,
    hydrate_dossier_from_backend_settings as _hydrate_dossier_from_backend_settings,
...
from src.core.dossier import capture_turn_memory, summarize_dossier_for_context
