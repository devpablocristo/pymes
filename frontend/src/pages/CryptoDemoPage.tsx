...
export function CryptoDemoPage() {
  const [tab, setTab] = useState<CryptoTab>('wallet');
  return (
    <div className="cry">
      <div className="page-header">
        <h1>Crypto</h1>
        <p style={{ color: 'var(--color-text-secondary)', margin: 0, fontSize: '0.88rem' }}>Billetera, marketplace y portfolio de criptomonedas — demo</p>
      </div>
