...
BEGIN
    ...
    SELECT id INTO q1 FROM quotes WHERE org_id = v_tenant AND number = 'PRE-00001' LIMIT 1;
    ...
    ON CONFLICT (org_id, number) DO NOTHING;
    SELECT id INTO q2 FROM quotes WHERE org_id = v_tenant AND number = 'PRE-00002' LIMIT 1;
    SELECT id INTO q3 FROM quotes WHERE org_id = v_tenant AND number = 'PRE-00003' LIMIT 1;
    ...
    ON CONFLICT (org_id, number) DO NOTHING;
    SELECT id INTO sale1 FROM sales WHERE org_id = v_tenant AND number = 'VTA-00001' LIMIT 1;
    SELECT id INTO sale2 FROM sales WHERE org_id = v_tenant AND number = 'VTA-00002' LIMIT 1;
    SELECT id INTO sale3 FROM sales WHERE org_id = v_tenant AND number = 'VTA-00003' LIMIT 1;
