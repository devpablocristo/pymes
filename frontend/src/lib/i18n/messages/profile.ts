...
export const profileMessages: TranslationsByLanguage = {
  es: {
    ...
    'profile.labels.org': 'Tenant',
    'profile.org.noOrganization':
      'No hay un tenant activo en esta sesión. Completá el onboarding o volvé a iniciar sesión.',
    'profile.org.readOnlyMember': 'Solo un administrador del tenant puede cambiar el nombre.',
    ...
    'profile.org.switchTitle': 'Tenants / Equipo',
    'profile.org.switchLead':
      'Podés cambiar a otro tenant donde ya tenés membresía. Los tenants nuevos se crean desde onboarding.',
  ...
  en: {
    ...
    'profile.labels.org': 'Tenant',
    'profile.org.noOrganization':
      'There is no active tenant in this session. Complete onboarding or sign in again.',
    'profile.org.readOnlyMember': 'Only a tenant admin can change the name.',
    ...
    'profile.org.switchTitle': 'Tenants / Team',
    'profile.org.switchLead':
      'You can switch to another tenant where you already have membership. New tenants are created from onboarding.',
