...
type usecasesPort interface {
	...
	Update(ctx context.Context, tenantID, id uuid.UUID, in UpdateInput, actor string) (domain.Bicycle, error)
...
func (h *Handler) RegisterRoutes(authGroup *gin.RouterGroup) {
	...
	authGroup.POST(bicyclesItemPath+"/"+crudpaths.SegmentArchive, h.Archive)
