...
type BikeWorkOrderModel struct {
	ID               uuid.UUID  `gorm:"type:uuid;primaryKey"`
	OrgID            uuid.UUID  `gorm:"type:uuid;index;not null"`
	Number           string     `gorm:"not null"`
	BicycleID        uuid.UUID  `gorm:"type:uuid;not null"`
...
func (BikeWorkOrderModel) TableName() string { return "workshops.bike_work_orders" }

type BikeWorkOrderItemModel struct {
	ID          uuid.UUID  `gorm:"type:uuid;primaryKey"`
	OrgID       uuid.UUID  `gorm:"type:uuid;index;not null"`
...
func (BikeWorkOrderItemModel) TableName() string { return "workshops.bike_work_order_items" }
