                ...
                <div className="card-body p-0 pagination-carousel dots-style-circle dots-positioned">
                    <Slider {...settings}>
                        <div className="gradient-overlay bottom-0 start-0 h-100">
                            <img
                                src="/wowdash-assets/images/carousel/carousel-img3.png"
                                alt=""
                        ...
                        <div className="gradient-overlay bottom-0 start-0 h-100">
                            <img
                                src="/wowdash-assets/images/carousel/carousel-img4.png"
                                alt=""
                                className="w-100 h-100 object-fit-cover"
                            />
                            <div className="position-absolute start-50 translate-middle-x bottom-0 pb-64 z-1 text-center w-100 max-w-440-px">
                        ...
                        <div className="gradient-overlay bottom-0 start-0 h-100">
                            <img
                                src="/wowdash-assets/images/carousel/carousel-img1.png"
                                alt=""
                                className="w-100 h-100 object-fit-cover"
                            />
                            <div className="position-absolute start-50 translate-middle-x bottom-0 pb-64 z-1 text-center w-100 max-w-440-px">
                        ...
                        <div className="gradient-overlay bottom-0 start-0 h-100">
                            <img
                                src="/wowdash-assets/images/carousel/carousel-img2.png"
                                alt=""
                                className="w-100 h-100 object-fit-cover"
                            />
                            <div className="position-absolute start-50 translate-middle-x bottom-0 pb-64 z-1 text-center w-100 max-w-440-px">
