            ...
            <section className="auth forgot-password-page bg-base d-flex flex-wrap">
                <div className="auth-left d-lg-block d-none">
                    <div className="d-flex align-items-center flex-column h-100 justify-content-center">
                        <img src="/wowdash-assets/images/auth/forgot-pass-img.png" alt="" />
                    </div>
                </div>
                    ...
                    <div className="max-w-464-px mx-auto w-100">
                        ...
                        <form action="#">
                            ...
                            <div className="text-center">
                                <Link to={w("/sign-in")} className="text-primary-600 fw-bold mt-24">
                                    Back to Sign In
                                </Link>
                            </div>
                            <div className="mt-120 text-center text-sm">
                                <p className="mb-0">
                                    ...
                                    <Link to={w("/sign-in")} className="text-primary-600 fw-semibold">
                                        Sign In
                                    </Link>
                                </p>
                            </div>
                ...
                <div className="modal-dialog modal-dialog modal-dialog-centered">
                    <div className="modal-content radius-16 bg-base">
                        <div className="modal-body p-40 text-center">
                            <div className="mb-32">
                                <img src="/wowdash-assets/images/auth/envelop-icon.png" alt="" />
                            </div>
                            ...
                            <div className="mt-32 text-sm">
                                <p className="mb-0">
                                    ...
                                    <Link to={w("/resend")} className="text-primary-600 fw-semibold">
                                        Resend
                                    </Link>
                                </p>
                            </div>
