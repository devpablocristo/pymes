            ...
            <div className="card p-0 overflow-hidden position-relative radius-12 h-100">
                ...
                <div className="card-body p-24">
                    <div className="d-flex align-items-center flex-wrap">
                        <img
                            src="/wowdash-assets/images/avatar/avatar-group1.png"
                            alt=""
                            className="w-24-px h-24-px rounded-circle object-fit-cover position-relative"
                        />
                        <img
                            src="/wowdash-assets/images/avatar/avatar-group2.png"
                            alt=""
                            className="w-24-px h-24-px rounded-circle object-fit-cover position-relative ms--10px"
                        />
                        <img
                            src="/wowdash-assets/images/avatar/avatar-group3.png"
                            alt=""
                            className="w-24-px h-24-px rounded-circle object-fit-cover position-relative ms--10px"
                        />
                        <img
                            src="/wowdash-assets/images/avatar/avatar-group4.png"
                            alt=""
                            className="w-24-px h-24-px rounded-circle object-fit-cover position-relative ms--10px"
                        />
                        <img
                            src="/wowdash-assets/images/avatar/avatar-group5.png"
                            alt=""
                            className="w-24-px h-24-px rounded-circle object-fit-cover position-relative ms--10px"
                        />
                        <img
                            src="/wowdash-assets/images/avatar/avatar-group6.png"
                            alt=""
                            className="w-24-px h-24-px rounded-circle object-fit-cover position-relative ms--10px"
                        />
                        <img
