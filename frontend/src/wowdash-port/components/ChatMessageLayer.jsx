        ...
        <div className="chat-wrapper">
            <div className="chat-sidebar card">
                <div className="chat-sidebar-single active top-profile">
                    <div className="img">
                        <img src="/wowdash-assets/images/chat/1.png" alt="image_icon" />
                    </div>
                    <div className="info">
                ...
                <div className="chat-all-list">
                    <div className="chat-sidebar-single active">
                        <div className="img">
                            <img src="/wowdash-assets/images/chat/2.png" alt="image_icon" />
                        </div>
                        <div className="info">
                    ...
                    <div className="chat-sidebar-single active">
                        <div className="img">
                            <img src="/wowdash-assets/images/chat/3.png" alt="image_icon" />
                        </div>
                        <div className="info">
                    ...
                    <div className="chat-sidebar-single">
                        <div className="img">
                            <img src="/wowdash-assets/images/chat/4.png" alt="image_icon" />
                        </div>
                        <div className="info">
                    ...
                    <div className="chat-sidebar-single">
                        <div className="img">
                            <img src="/wowdash-assets/images/chat/5.png" alt="image_icon" />
                        </div>
                        <div className="info">
                    ...
                    <div className="chat-sidebar-single active">
                        <div className="img">
                            <img src="/wowdash-assets/images/chat/6.png" alt="image_icon" />
                        </div>
                        <div className="info">
                    ...
                    <div className="chat-sidebar-single active">
                        <div className="img">
                            <img src="/wowdash-assets/images/chat/7.png" alt="image_icon" />
                        </div>
                        <div className="info">
                    ...
                    <div className="chat-sidebar-single active">
                        <div className="img">
                            <img src="/wowdash-assets/images/chat/8.png" alt="image_icon" />
                        </div>
                        <div className="info">
                    ...
                    <div className="chat-sidebar-single active">
                        <div className="img">
                            <img src="/wowdash-assets/images/chat/9.png" alt="image_icon" />
                        </div>
                        <div className="info">
                    ...
                    <div className="chat-sidebar-single active">
                        <div className="img">
                            <img src="/wowdash-assets/images/chat/10.png" alt="image_icon" />
                        </div>
                        <div className="info">
            ...
            <div className="chat-main card">
                <div className="chat-sidebar-single active">
                    <div className="img">
                        <img src="/wowdash-assets/images/chat/11.png" alt="image_icon" />
                    </div>
                    <div className="info">
                        <h6 className="text-md mb-0">Kathryn Murphy</h6>
                        <p className="mb-0">Available</p>
                ...
                <div className="chat-message-list">
                    <div className="chat-single-message left">
                        <img
                            src="/wowdash-assets/images/chat/11.png"
                            alt="image_icon"
