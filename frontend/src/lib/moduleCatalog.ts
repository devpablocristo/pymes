    ...
    datasets: [
      {
        id: 'parties-list',
        title: 'Parties',
        description: 'Listado consolidado del modelo party.',
        path: '/v1/parties',
        autoLoad: true,
      },
    ],
    actions: [
      {
        ...
        title: 'Relaciones de party',
        description: 'Consulta relaciones por party ID.',
        path: '/v1/parties/:partyId/relationships',
        method: 'GET',
        fields: [{ name: 'partyId', label: 'Party ID', location: 'path', required: true }],
      },
    ],
  },
  customers: {
    ...
    actions: [
      {
        ...
        method: 'GET',
        fields: [{ name: 'quoteId', label: 'Quote ID', location: 'path', required: true }],
      },
      {
        id: 'quote-send',
    ...
    actions: [
      {
        ...
        method: 'GET',
        fields: [{ name: 'saleId', label: 'Sale ID', location: 'path', required: true }],
      },
      {
        id: 'sale-void',
        title: 'Anular venta',
    ...
    actions: [
      {
        ...
        method: 'GET',
        fields: [{ name: 'purchaseId', label: 'Purchase ID', location: 'path', required: true }],
      },
    ],
  },
  accounts: {
    ...
    actions: [
      ...
      },
      {
        ...
        fields: [
          ...
          { name: 'method', label: 'Metodo', location: 'body', required: true, placeholder: 'cash, transfer, card' },
          { name: 'amount', label: 'Importe', location: 'body', type: 'number', required: true },
          { name: 'received_at', label: 'Recibido en', location: 'body', placeholder: '2026-03-06T10:00:00Z' },
    ...
    actions: [
      {
        ...
        method: 'GET',
        fields: [{ name: 'returnId', label: 'Return ID', location: 'path', required: true }],
      },
      {
        ...
        method: 'GET',
        fields: [{ name: 'creditNoteId', label: 'Credit note ID', location: 'path', required: true }],
      },
      {
    ...
    actions: [
      {
        ...
        method: 'GET',
        fields: [{ name: 'roleId', label: 'Role ID', location: 'path', required: true }],
      },
      {
        id: 'user-permissions',
        ...
        method: 'GET',
        fields: [{ name: 'userId', label: 'User ID', location: 'path', required: true }],
      },
    ],
  },
  timeline: {
    ...
    actions: [
      {
        ...
        method: 'GET',
        fields: [
          { name: 'entity', label: 'Entidad', location: 'path', required: true, placeholder: 'sales, quotes, products' },
          { name: 'entityId', label: 'Entity ID', location: 'path', required: true },
        ],
      },
      {
        id: 'timeline-note',
        ...
        fields: [
          { name: 'entity', label: 'Entidad', location: 'path', required: true, placeholder: 'sales, quotes, products' },
          { name: 'entityId', label: 'Entity ID', location: 'path', required: true },
          { name: 'title', label: 'Titulo', location: 'body', placeholder: 'Nota manual' },
    ...
    actions: [
      {
        ...
        method: 'GET',
        fields: [
          { name: 'entity', label: 'Entidad', location: 'path', required: true, placeholder: 'sales, quotes, purchases' },
          { name: 'entityId', label: 'Entity ID', location: 'path', required: true },
        ],
      },
      {
        ...
        method: 'GET',
        fields: [{ name: 'attachmentId', label: 'Attachment ID', location: 'path', required: true }],
      },
      {
    ...
    actions: [
      {
        ...
        method: 'GET',
        fields: [{ name: 'endpointId', label: 'Endpoint ID', location: 'path', required: true }],
      },
      {
        id: 'webhook-test',
      ...
      },
      {
        ...
        response: 'json',
        sendEmptyBody: true,
        fields: [{ name: 'deliveryId', label: 'Delivery ID', location: 'path', required: true }],
      },
    ],
  },
  whatsapp: {
