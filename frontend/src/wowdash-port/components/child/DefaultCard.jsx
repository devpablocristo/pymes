            ...
            <div className="row gy-4">
                <div className="col-xxl-3 col-sm-6">
                    <div className="card h-100 radius-12">
                        <img
                            src="/wowdash-assets/images/card-component/card-img1.png"
             ...
             mb-6"
                ...
                <div className="col-xxl-3 col-sm-6">
                    <div className="card h-100 radius-12">
                        <img
                            src="/wowdash-assets/images/card-component/card-img2.png"
                            className="card-img-top"
                            alt=""
                        />
             ...
             mb-6"
                ...
                <div className="col-xxl-3 col-sm-6">
                    <div className="card h-100 radius-12">
                        <img
                            src="/wowdash-assets/images/card-component/card-img3.png"
                            className="card-img-top"
                            alt=""
                        />
             ...
             mb-6"
                ...
                <div className="col-xxl-3 col-sm-6">
                    <div className="card h-100 radius-12">
                        <img
                            src="/wowdash-assets/images/card-component/card-img4.png"
                            className="card-img-top"
                            alt=""
                        />
                        <div className="card-body p-16 text-center">
