module github.com/devpablocristo/pymes/v2/backend

go 1.26.5

require (
	github.com/devpablocristo/platform/databases/postgres/go v0.5.0
	github.com/devpablocristo/platform/iam/go v0.2.0
...
require (
	...
	github.com/devpablocristo/platform/lifecycle/go v0.3.0 // indirect
	...
	github.com/svix/svix-webhooks v1.99.1 // indirect
