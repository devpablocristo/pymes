...
export const profileMessages: TranslationsByLanguage = {
  es: {
    ...
    'profile.org.switchLoading': 'Cambiando tenant…',
    'profile.org.switchEmpty': 'Todavía no tenés otros tenants disponibles.',
    'profile.org.switchError': 'No se pudo cambiar de tenant. Reintentá.',
