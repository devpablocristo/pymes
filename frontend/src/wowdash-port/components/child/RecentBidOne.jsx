                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <div className="d-flex align-items-center">
                                                <img
                                                    src="/wowdash-assets/images/nft/nft-items-img1.png"
                                                    alt=""
                                        ...
                                        <td>
                                            <div className="d-flex align-items-center">
                                                <img
                                                    src="/wowdash-assets/images/nft/nft-offer-img1.png"
                                                    alt=""
                                                    className="flex-shrink-0 me-12 w-40-px h-40-px rounded-circle me-12"
                                                />
                                                <div className="flex-grow-1">
                                    ...
                                    <tr>
                                        <td>
                                            <div className="d-flex align-items-center">
                                                <img
                                                    src="/wowdash-assets/images/nft/nft-items-img2.png"
                                                    alt=""
                                                    className="flex-shrink-0 me-12 w-40-px h-40-px rounded-circle me-12"
                                                />
                                                <div className="flex-grow-1">
                                        ...
                                        <td>
                                            <div className="d-flex align-items-center">
                                                <img
                                                    src="/wowdash-assets/images/nft/nft-offer-img2.png"
                                                    alt=""
                                                    className="flex-shrink-0 me-12 w-40-px h-40-px rounded-circle me-12"
                                                />
                                                <div className="flex-grow-1">
                                    ...
                                    <tr>
                                        <td>
                                            <div className="d-flex align-items-center">
                                                <img
                                                    src="/wowdash-assets/images/nft/nft-items-img3.png"
                                                    alt=""
                                                    className="flex-shrink-0 me-12 w-40-px h-40-px rounded-circle me-12"
                                                />
                                                <div className="flex-grow-1">
                                        ...
                                        <td>
                                            <div className="d-flex align-items-center">
                                                <img
                                                    src="/wowdash-assets/images/nft/nft-offer-img3.png"
                                                    alt=""
                                                    className="flex-shrink-0 me-12 w-40-px h-40-px rounded-circle me-12"
                                                />
                                                <div className="flex-grow-1">
                                    ...
                                    <tr>
                                        <td>
                                            <div className="d-flex align-items-center">
                                                <img
                                                    src="/wowdash-assets/images/nft/nft-items-img4.png"
                                                    alt=""
                                                    className="flex-shrink-0 me-12 w-40-px h-40-px rounded-circle me-12"
                                                />
                                                <div className="flex-grow-1">
                                        ...
                                        <td>
                                            <div className="d-flex align-items-center">
                                                <img
                                                    src="/wowdash-assets/images/nft/nft-offer-img4.png"
                                                    alt=""
                                                    className="flex-shrink-0 me-12 w-40-px h-40-px rounded-circle me-12"
                                                />
                                                <div className="flex-grow-1">
                                    ...
                                    <tr>
                                        <td>
                                            <div className="d-flex align-items-center">
                                                <img
                                                    src="/wowdash-assets/images/nft/nft-items-img5.png"
                                                    alt=""
                                                    className="flex-shrink-0 me-12 w-40-px h-40-px rounded-circle me-12"
                                                />
                                                <div className="flex-grow-1">
                                        ...
                                        <td>
                                            <div className="d-flex align-items-center">
                                                <img
                                                    src="/wowdash-assets/images/nft/nft-offer-img5.png"
                                                    alt=""
                                                    className="flex-shrink-0 me-12 w-40-px h-40-px rounded-circle me-12"
                                                />
                                                <div className="flex-grow-1">
                                    ...
                                    <tr>
                                        <td>
                                            <div className="d-flex align-items-center">
                                                <img
                                                    src="/wowdash-assets/images/nft/nft-items-img6.png"
                                                    alt=""
                                                    className="flex-shrink-0 me-12 w-40-px h-40-px rounded-circle me-12"
                                                />
                                                <div className="flex-grow-1">
                                        ...
                                        <td>
                                            <div className="d-flex align-items-center">
                                                <img
                                                    src="/wowdash-assets/images/nft/nft-offer-img6.png"
                                                    alt=""
                                                    className="flex-shrink-0 me-12 w-40-px h-40-px rounded-circle me-12"
                                                />
                                                <div className="flex-grow-1">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div className="d-flex align-items-center">
                                                <img
                                                    src="/wowdash-assets/images/nft/nft-offer-img7.png"
                                                    alt=""
                                                    className="flex-shrink-0 me-12 w-40-px h-40-px rounded-circle me-12"
                                                />
                                                <div className="flex-grow-1">
