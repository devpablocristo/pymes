...
import (
	...
	"github.com/devpablocristo/pymes/beauty/backend/internal/shared/values"
)
...
func (u *Usecases) enrichLinkedProduct(ctx context.Context, in *domain.SalonService) error {
