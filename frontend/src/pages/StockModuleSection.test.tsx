...
import { StockModuleSection } from './StockModuleSection';
...
vi.mock('./modes/ProductsGalleryModeContent', () => ({
...
describe('StockModuleSection', () => {
  beforeEach(() => {
    window.localStorage.clear();
    loadLazyCrudPageConfigMock.mockReset();
    loadLazyCrudPageConfigMock.mockResolvedValue(buildStockConfig());
  });

  it('uses the reusable configured section and replaces configure with back-to-inventory on the configure route', async () => {
    render(
      <MemoryRouter
        initialEntries={['/modules/stock/configure']}
