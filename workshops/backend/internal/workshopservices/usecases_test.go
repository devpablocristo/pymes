...
func (f *fakeRepo) List(ctx context.Context, p ListParams) ([]Service, int64, bool, *uuid.UUID, error) {
	_ = ctx
	_ = p
	return nil, 0, false, nil, nil
}

func (f *fakeRepo) Create(ctx context.Context, in Service) (Service, error) {
	_ = ctx
	f.created = in
	in.ID = uuid.New()
	return in, nil
...
func (f *fakeRepo) GetByID(ctx context.Context, orgID, id uuid.UUID) (Service, error) {
	_ = ctx
	_ = orgID
	_ = id
	return Service{}, nil
...
func (f *fakeRepo) Update(ctx context.Context, in Service) (Service, error) {
	_ = ctx
	return in, nil
}
...
func TestCreateEnrichesLinkedProductDefaults(t *testing.T) {
	...
	out, err := uc.Create(context.Background(), Service{
		OrgID:           orgID,
		Code:            "ACEITE",
