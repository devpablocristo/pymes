...
from src.api.professionals_deps import get_professionals_backend_client, get_llm_provider
...
from src.tools.professionals.registry import build_external_tools

router = APIRouter(prefix="/v1/professionals/public", tags=["professionals-public-chat"])
