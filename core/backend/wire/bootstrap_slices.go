...
import (
	...
	"github.com/devpablocristo/pymes/core/backend/internal/axiscallbacks"
...
func registerInternalV1Routes(v1 *gin.RouterGroup, internalServiceToken, governanceCallbackToken string, registrars internalV1Registrars, require schedulinghttp.PermissionBinder) {
	...
	governanceCallbackGroup.Use(axiscallbacks.NewNexusCallbackAuth(axiscallbacks.Config{
		Token:   governanceCallbackToken,
