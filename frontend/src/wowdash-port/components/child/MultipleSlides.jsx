            ...
            <div className="card p-0 overflow-hidden position-relative radius-12">
                ...
                <div className="card-body py-24 px-16 multiple-carousel dots-style-circle">
                    <Slider {...settings}>
                        <div className=" mb-24">
                            <img
                                src="/wowdash-assets/images/carousel/mutiple-carousel-img1.png"
                        ...
                        <div className=" mb-24">
                            <img
                                src="/wowdash-assets/images/carousel/mutiple-carousel-img2.png"
                                className="w-100 h-100 object-fit-cover"
                                alt=""
                            />
                        </div>
                        <div className=" mb-24">
                            <img
                                src="/wowdash-assets/images/carousel/mutiple-carousel-img3.png"
                                className="w-100 h-100 object-fit-cover"
                                alt=""
                            />
                        </div>
                        <div className=" mb-24">
                            <img
                                src="/wowdash-assets/images/carousel/mutiple-carousel-img4.png"
                                className="w-100 h-100 object-fit-cover"
                                alt=""
                            />
                        </div>
