                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td className="bg-primary-light">
                                        <div className="d-flex align-items-center">
                                            <img
                                                src="/wowdash-assets/images/users/user1.png"
                                                alt=""
                                ...
                                <tr>
                                    ...
                                    <td className="bg-success-focus">
                                        <div className="d-flex align-items-center">
                                            <img
                                                src="/wowdash-assets/images/users/user2.png"
                                                alt=""
                                                className="w-40-px h-40-px rounded-circle flex-shrink-0 me-12 overflow-hidden"
                                            />
                                            <h6 className="text-md mb-0 fw-medium flex-grow-1">
                                ...
                                <tr>
                                    ...
                                    <td className="bg-info-focus">
                                        <div className="d-flex align-items-center">
                                            <img
                                                src="/wowdash-assets/images/users/user3.png"
                                                alt=""
                                                className="w-40-px h-40-px rounded-circle flex-shrink-0 me-12 overflow-hidden"
                                            />
                                            <h6 className="text-md mb-0 fw-medium flex-grow-1">
                                ...
                                <tr>
                                    ...
                                    <td className="bg-warning-focus">
                                        <div className="d-flex align-items-center">
                                            <img
                                                src="/wowdash-assets/images/users/user4.png"
                                                alt=""
                                                className="w-40-px h-40-px rounded-circle flex-shrink-0 me-12 overflow-hidden"
                                            />
                                            <h6 className="text-md mb-0 fw-medium flex-grow-1">
                                ...
                                <tr>
                                    ...
                                    <td className="bg-danger-focus">
                                        <div className="d-flex align-items-center">
                                            <img
                                                src="/wowdash-assets/images/users/user5.png"
                                                alt=""
                                                className="w-40-px h-40-px rounded-circle flex-shrink-0 me-12 overflow-hidden"
                                            />
                                            <h6 className="text-md mb-0 fw-medium flex-grow-1">
