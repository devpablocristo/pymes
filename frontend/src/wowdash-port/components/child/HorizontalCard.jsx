            ...
            <div className="row gy-4">
                <div className="col-xl-6">
                    <div className="card radius-12 overflow-hidden h-100 d-flex align-items-center flex-nowrap flex-row">
                        <div className="d-flex flex-shrink-0 w-170-px h-100">
                            <img
                                src="/wowdash-assets/images/card-component/horizontal-card-img1.png"
                ...
                <div className="col-xl-6">
                    <div className="card radius-12 overflow-hidden h-100 d-flex align-items-center flex-nowrap flex-row flex-row-reverse">
                        <div className="d-flex flex-shrink-0 w-170-px h-100">
                            <img
                                src="/wowdash-assets/images/card-component/horizontal-card-img2.png"
                                className="h-100 w-100 object-fit-cover"
                                alt=""
                            />
                        </div>
                ...
                <div className="col-xl-6">
                    <div className="card radius-12 overflow-hidden h-100 d-flex align-items-center flex-nowrap flex-row">
                        <div className="d-flex flex-shrink-0 w-170-px h-100">
                            <img
                                src="/wowdash-assets/images/card-component/horizontal-card-img3.png"
                                className="h-100 w-100 object-fit-cover"
                                alt=""
                            />
                        </div>
                ...
                <div className="col-xl-6">
                    <div className="card radius-12 overflow-hidden h-100 d-flex align-items-center flex-nowrap flex-row flex-row-reverse">
                        <div className="d-flex flex-shrink-0 w-170-px h-100">
                            <img
                                src="/wowdash-assets/images/card-component/horizontal-card-img4.png"
                                className="h-100 w-100 object-fit-cover"
                                alt=""
                            />
                        </div>
