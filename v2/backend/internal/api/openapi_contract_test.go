...
func assertBusinessOperations(t *testing.T, spec *openapi3.T) {
	...
	expected := map[string]string{
		...
		http.MethodGet + " /api/v1/accounting/fiscal-years":                                      "ListAccountingFiscalYears",
		http.MethodPost + " /api/v1/accounting/fiscal-years":                                     "CreateAccountingFiscalYear",
		http.MethodGet + " /api/v1/accounting/fiscal-years/{fiscal_year_id}":                     "GetAccountingFiscalYear",
		http.MethodPost + " /api/v1/accounting/fiscal-years/{fiscal_year_id}/annual-close-draft": "CreateFiscalYearAnnualClosingDraft",
		http.MethodPost + " /api/v1/accounting/fiscal-years/{fiscal_year_id}/reopen":             "ReopenAccountingFiscalYear",
		http.MethodPut + " /api/v1/accounting/settings/fiscal-calendar":                          "UpdateAccountingFiscalCalendar",
		http.MethodPost + " /api/v1/accounting/periods":                                          "CreateAccountingPeriod",
		http.MethodGet + " /api/v1/accounting/periods/{period_id}":                               "GetAccountingPeriod",
		http.MethodGet + " /api/v1/accounting/periods/{period_id}/events":                        "ListAccountingPeriodEvents",
		http.MethodPost + " /api/v1/accounting/statement-imports":                                "ImportAccountingStatement",
		http.MethodGet + " /api/v1/accounting/general-ledger":                                    "GetGeneralLedger",
		http.MethodGet + " /api/v1/accounting/general-ledger/export":                             "ExportGeneralLedger",
		http.MethodGet + " /api/v1/accounting/trial-balance":                                     "GetTrialBalance",
		http.MethodGet + " /api/v1/accounting/trial-balance/export":                              "ExportTrialBalance",
