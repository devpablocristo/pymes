...
export const onboardingMessages: TranslationsByLanguage = {
  es: {
    ...
    'onboarding.vertical.teachers': 'Docencia / Academia',
    'onboarding.vertical.teachersDesc': 'Clases, alumnos, cursos y sesiones',
    'onboarding.vertical.consulting': 'Consultorio / Atención',
    'onboarding.vertical.consultingDesc': 'Pacientes, atención y seguimiento',
    'onboarding.vertical.workshops': 'Talleres',
    'onboarding.vertical.workshopsDesc': 'Órdenes de trabajo, diagnósticos y reparaciones',
    'onboarding.vertical.autoRepair': 'Taller mecánico',
    'onboarding.vertical.autoRepairDesc': 'Autos, motos, vehículos y reparaciones',
    ...
    'onboarding.vertical.salon': 'Salón de belleza',
    'onboarding.vertical.salonDesc': 'Equipo, servicios, turnos y atención',
    'onboarding.vertical.barbershop': 'Barbería',
    'onboarding.vertical.barbershopDesc': 'Barberos, servicios y agenda',
    'onboarding.vertical.aesthetics': 'Estética / Gabinete',
    'onboarding.vertical.aestheticsDesc': 'Tratamientos, agenda y seguimiento',
    'onboarding.vertical.restaurants': 'Bares / Restaurantes',
    'onboarding.vertical.restaurantsDesc': 'Salón, mesas y sesiones',
    'onboarding.vertical.restaurant': 'Restaurante',
    'onboarding.vertical.restaurantDesc': 'Salón, mesas, cuentas y servicio',
    'onboarding.vertical.bar': 'Bar',
  ...
  en: {
    ...
    'onboarding.vertical.teachers': 'Teaching / Academy',
    'onboarding.vertical.teachersDesc': 'Classes, students, courses and sessions',
    'onboarding.vertical.consulting': 'Practice / Care',
    'onboarding.vertical.consultingDesc': 'Patients, care and follow-up',
    'onboarding.vertical.workshops': 'Workshops',
    'onboarding.vertical.workshopsDesc': 'Work orders, diagnostics and repairs',
    'onboarding.vertical.autoRepair': 'Auto repair shop',
    'onboarding.vertical.autoRepairDesc': 'Cars, motorcycles, vehicles and repairs',
    ...
    'onboarding.vertical.salon': 'Beauty salon',
    'onboarding.vertical.salonDesc': 'Staff, services, bookings and customer care',
    'onboarding.vertical.barbershop': 'Barbershop',
    'onboarding.vertical.barbershopDesc': 'Barbers, services and bookings',
    'onboarding.vertical.aesthetics': 'Aesthetics / Studio',
    'onboarding.vertical.aestheticsDesc': 'Treatments, bookings and follow-up',
    'onboarding.vertical.restaurants': 'Bars / Restaurants',
    'onboarding.vertical.restaurantsDesc': 'Dining, tables and sessions',
    'onboarding.vertical.restaurant': 'Restaurant',
    'onboarding.vertical.restaurantDesc': 'Dining room, tables, checks and service',
    'onboarding.vertical.bar': 'Bar',
