...
SEED_DB_CHECKS=(
  ...
  "agenda|$SEED_MIN_VISIBLE|SELECT count(*) FROM scheduling_bookings WHERE tenant_id = '__ORG_ID__'::uuid AND start_at >= CURRENT_DATE - interval '1 day' AND start_at < CURRENT_DATE + interval '14 days'"
