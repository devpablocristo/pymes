...
import (
	...
	"github.com/devpablocristo/pymes/v3/backend/internal/commerce/domain"
...
func TestDurableWorkerPostsPaysAndReversesPurchase(t *testing.T) {
	...
	worker := usecases.DurableWorker{
		Store: store, Fiscal: companion.NewFakeFiscal(),
		Accounting: companion.NewFakeAccounting(), LeaseFor: time.Minute,
	}
