...
import (
	...
	identity "github.com/devpablocristo/pymes/v3/backend/internal/identity/usecases/domain"
)
...
func (f *originRecordingFiscal) Authorize(
	...
	return originFiscalResultForRequest(request), nil
}
...
func originFiscalResultForRequest(request domain.FiscalRequest) domain.FiscalResult {
