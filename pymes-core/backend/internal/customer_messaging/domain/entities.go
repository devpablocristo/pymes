...
// DeliveryMode define cómo se entrega un contacto al cliente.
type DeliveryMode string

const (
	DeliveryModeShareLink       DeliveryMode = "share_link"
	DeliveryModeOfficialChannel DeliveryMode = "official_channel"
)
